...
export const PersonalInfoSchema = z.object({
  ...
  linkedinUrl: z.string().min(1, { message: "LinkedIn URL is required" }).max(500, { message: "LinkedIn URL is too long" }),
  portfolioUrl: z.string().min(1, { message: "Portfolio URL is required" }).max(500, { message: "Portfolio URL is too long" }),
  githubUrl: z.string().min(1, { message: "GitHub URL is required" }).max(500, { message: "GitHub URL is too long" }),
});
